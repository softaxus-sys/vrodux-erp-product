...
export const restaurantOrders: RestaurantOrder[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { menuItemId: "m-012", name: "Truffle Fettuccine", price: 110, quantity: 2, total: 220, notes: "No truffle for one guest — allergy", status: "pending" },
      { menuItemId: "m-016", name: "Chocolate Lava Cake", price: 55, quantity: 7, total: 385, notes: "", status: "pending" },
    ],
  ...
  },
  {
    ...
    items: [
      { menuItemId: "m-003", name: "Grilled Halloumi", price: 55, quantity: 1, total: 55, notes: "", status: "pending" },
      { menuItemId: "m-021", name: "Mint Shisha", price: 120, quantity: 1, total: 120, notes: "", status: "pending" },
      { menuItemId: "m-018", name: "Arabic Coffee Pot", price: 35, quantity: 1, total: 35, notes: "", status: "pending" },
    ],
...
export const kdsOrders: KDSOrder[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "ki-007", name: "Truffle Fettuccine (NO TRUFFLE)", quantity: 1, notes: "⚠️ ALLERGY — no truffle", status: "pending", prepTime: 18 },
    ],
  },
  {
