    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="bg-muted/30 rounded-xl p-4 space-y-0">
          ...
          <InfoRow icon={Phone} label="Office" value={emp.phone} />
          <InfoRow icon={Calendar} label="Date of Birth" value={formatDate(emp.dateOfBirth, "medium")} />
          <InfoRow icon={User} label="Gender" value={<span className="capitalize">{emp.gender}</span>} />
          <InfoRow icon={Shield} label="Nationality" value={emp.nationality} />
      ...
      <div>
        ...
        <div className="bg-muted/30 rounded-xl p-4 space-y-0">
          ...
          <InfoRow icon={User} label="Reports To" value={emp.reportingTo} />
          <InfoRow icon={MapPin} label="Branch" value={emp.branch} />
...
function LeaveTab({ emp }: { emp: Employee }) {
  const leaveTypes = [
    { type: "Annual Leave", balance: emp.annualLeaveBalance, total: 30, color: "bg-primary" },
    { type: "Sick Leave", balance: emp.sickLeaveBalance, total: 15, color: "bg-warning" },
