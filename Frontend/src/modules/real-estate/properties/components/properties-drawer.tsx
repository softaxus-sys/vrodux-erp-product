...
import type { PropertyDto as Property } from "@/lib/real-estate/real-estate.api";
          ...
          >
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground flex items-center gap-1 mt-0.5">
                        ...
                        {property.locationCity}, {property.locationEmirate}
                      </p>
                    </div>
                    <span
                      className={cn(
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-6">
              ...
              <div>
                ...
                <div className="bg-muted/30 rounded-xl p-4 space-y-0">
                  <InfoRow icon={MapPin} label="Address" value={property.locationAddress} />
