        ...
        <>
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-border shrink-0">
              <div>
                <h2 className="text-base font-bold text-foreground">New Purchase Invoice</h2>
                <p className="text-xs text-muted-foreground mt-0.5">Record a vendor bill (AP)</p>
              </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-5">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input value={reference} onChange={e => setReference(e.target.value)} placeholder="Vendor invoice #" className="h-9 text-sm" />
                </div>
              </div>
                ...
                <div className="border border-border rounded-xl overflow-hidden">
                  <table className="w-full text-sm">
                    ...
                    <tfoot className="bg-muted/10 border-t border-border text-xs">
                      ...
                      {taxed && (
                        <tr>
                          <td colSpan={3} className="px-3 py-2 text-right text-muted-foreground">Tax ({taxRate}%)</td>
              ...
              <div className="space-y-1.5">
                ...
                <textarea value={notes} onChange={e => setNotes(e.target.value)}
                  placeholder="Additional details about this invoice…" rows={3}
            ...
            <div className="px-6 py-4 border-t border-border flex gap-2 justify-between shrink-0">
              ...
              <Button onClick={handleSubmit} disabled={!isValid || isPending}>
                {isPending ? <><Loader2 className="w-3.5 h-3.5 mr-1 animate-spin" />Saving…</> : "Create Invoice"}
              </Button>
            </div>
          </motion.div>
        </>
