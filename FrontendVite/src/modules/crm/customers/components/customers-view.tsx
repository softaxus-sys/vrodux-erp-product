...
export function CustomersView() {
  ...
  return (
    <div className="space-y-6">
      ...
      <CustomerDrawer customer={selectedCustomer} open={drawerOpen} onClose={() => setDrawerOpen(false)} onEdit={openEditCustomer} />
      <AddCustomerForm open={showAddForm} onClose={closeCustomerForm} editing={editingCustomer} />
    </div>
  );
}
