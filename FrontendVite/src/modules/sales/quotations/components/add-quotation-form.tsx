...
export function AddQuotationForm({ open, onClose }: AddQuotationFormProps) {
  ...
  const reset = () => {
    setCustomer(""); setValidUntil(""); setTaxRate(17); setDiscountPct(0);
