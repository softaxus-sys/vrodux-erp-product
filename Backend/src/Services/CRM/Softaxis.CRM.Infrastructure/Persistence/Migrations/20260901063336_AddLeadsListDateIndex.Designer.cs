...
namespace Softaxis.CRM.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260901063336_AddLeadsListDateIndex")]
    partial class AddLeadsListDateIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Softaxis.CRM.Domain.Entities.Lead", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("LeadDate", "Id"), new[] { "TenantId", "IsDeleted", "Status", "AssignedToUserId", "TeamId" });
