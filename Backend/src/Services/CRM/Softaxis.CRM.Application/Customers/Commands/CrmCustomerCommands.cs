...
public sealed record CreateCrmCustomerCommand(
    ...
    Guid? AccountManagerUserId = null, Guid? TeamId = null, string? PaymentTerms = null) : ICommand<CrmCustomerDto>;
...
public sealed record UpdateCrmCustomerCommand(
    ...
    List<string>? Tags, Guid? AccountManagerUserId = null, Guid? TeamId = null, string? PaymentTerms = null) : ICommand;
