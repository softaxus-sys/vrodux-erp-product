...
namespace Softaxis.Sales.API.Authorization;

/// <summary>
/// Requires the current user to hold the given permission key (e.g. "sales.orders.create")
/// as a "permission" claim, or to be a super admin. Returns 403 with the same
/// <c>{ Code, Description }</c> error shape used elsewhere in the Sales API.
