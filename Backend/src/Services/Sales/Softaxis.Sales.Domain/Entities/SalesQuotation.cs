...
public sealed class SalesQuotation
{
    ...
    public SalesQuotation(Guid? customerId, string? customerName, string? notes,
        string? validUntil, decimal discountPercent)
    {
        Id              = Guid.NewGuid();
    ...
    public string  Status          { get; private set; } = "draft"; // draft | sent | approved | rejected | converted | expired
