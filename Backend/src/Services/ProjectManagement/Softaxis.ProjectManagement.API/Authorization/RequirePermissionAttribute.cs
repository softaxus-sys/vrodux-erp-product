...
namespace Softaxis.ProjectManagement.API.Authorization;

/// <summary>
/// Requires the current user to hold the given permission key (e.g. "project-management.issues.edit")
/// as a "permission" claim, or to be a super admin. Returns 403 with the same
/// <c>{ Code, Description }</c> shape as <see cref="Common.ProjectManagementControllerBase"/>'s error responses.
/// </summary>
