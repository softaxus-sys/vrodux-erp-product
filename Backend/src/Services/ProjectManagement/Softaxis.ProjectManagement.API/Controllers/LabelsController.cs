...
public sealed class LabelsController(ISender sender) : ProjectManagementControllerBase
{
    ...
    [HttpGet]
    [RequirePermission("project-management.labels.view")]
    ...
    [HttpPost]
    [RequirePermission("project-management.labels.create")]
    ...
    [HttpPut("{id:guid}")]
    [RequirePermission("project-management.labels.edit")]
    ...
    [HttpDelete("{id:guid}")]
    [RequirePermission("project-management.labels.delete")]
