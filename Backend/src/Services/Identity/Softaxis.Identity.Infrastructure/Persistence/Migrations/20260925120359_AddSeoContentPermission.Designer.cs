...
namespace Softaxis.Identity.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925120359_AddSeoContentPermission")]
    partial class AddSeoContentPermission
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Softaxis.Identity.Domain.Entities.BillingSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("PayPalPlans")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("PayPalUseSandbox")
                        .HasColumnType("bit");

                    b.Property<bool>("StripeEnabled")
                        .HasColumnType("bit");

                    b.Property<string>("StripePrices")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("billing_settings", "identity");
                });
            ...
            modelBuilder.Entity("Softaxis.Identity.Domain.Entities.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("eb7669e1-7987-ba07-7ba4-d97d5aaa7920"),
                            Action = "import",
                            Description = "Import settings integrations",
                            ModuleId = "settings.integrations"
                        },
                        new
                        {
                        ...
                        new
                        {
                            Id = new Guid("d4662176-9d5e-fd8c-2d14-a4876b68bdd4"),
                            Action = "view",
                            Description = "View seo content",
                            ModuleId = "seo.content"
                        },
                        new
                        {
                            Id = new Guid("7a63d4a8-8ba4-8ec8-c90e-d5e67a9e27e0"),
                            Action = "edit",
                            Description = "Edit seo content",
                            ModuleId = "seo.content"
                        },
                        new
                        {
                        ...
                        new
                        {
                            Id = new Guid("4978b70f-0360-4765-9f48-77143526e6ef"),
                            Action = "view-confidential",
                            Description = "View-confidential real-estate units",
                            ModuleId = "real-estate.units"
                        },
                        new
                        {
                        ...
                        new
                        {
                            Id = new Guid("9a60b8fa-5ca8-61c3-9c77-062d2a698370"),
                            Action = "view",
                            Description = "View real-estate website",
                            ModuleId = "real-estate.website"
                        },
                        new
                        {
                            Id = new Guid("78b11942-c149-d072-d0e2-bf1b47674f70"),
                            Action = "edit",
                            Description = "Edit real-estate website",
                            ModuleId = "real-estate.website"
                        });
                });
            ...
            modelBuilder.Entity("Softaxis.Identity.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.Property<bool>("ModulesManuallyGranted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("Softaxis.Identity.Domain.Entities.TenantSyncSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("ReseedRequired")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("tenant_sync_settings", "identity");
                });
