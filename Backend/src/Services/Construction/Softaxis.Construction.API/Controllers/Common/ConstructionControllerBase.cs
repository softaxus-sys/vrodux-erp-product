...
namespace Softaxis.Construction.API.Controllers.Common;

/// <summary>
/// Base controller for all Construction API controllers.
/// Converts Result/Result&lt;T&gt; to the appropriate HTTP response without
/// littering every action with if/else boilerplate.
/// </summary>
[ApiController]
public abstract class ConstructionControllerBase : ControllerBase
{
