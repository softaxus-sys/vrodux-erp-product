...
namespace Softaxis.Seo.API.Authorization;

/// <summary>Requires the current user to hold the given permission key (e.g. "seo.sites.edit") as a
/// "permission" claim, or to be a super admin. Same pattern as every other service.</summary>
